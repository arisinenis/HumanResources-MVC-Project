...
{
    public class PackageCreateVMValidator : AbstractValidator<Package>
    {
        public PackageCreateVMValidator()
        {
            // Datelerin diğer kontrolleri business katmanında yapılabilir.
            RuleFor(x => x.Name).NotEmpty().WithMessage("Lütfen Paket ismi giriniz.").NotNull().WithMessage("Lütfen Paket ismi giriniz.");
